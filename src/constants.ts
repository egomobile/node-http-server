...
export const INIT_CONTROLLER_AUTHORIZE = Symbol("INIT_CONTROLLER_AUTHORIZE");
...
export const PARSE_ERROR_HANDLER = Symbol("PARSE_ERROR_HANDLER");
export const PREPARE_CONTROLLER_METHOD_ACTIONS = Symbol("PREPARE_CONTROLLER_METHOD_ACTIONS");
