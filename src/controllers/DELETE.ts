...
export function DELETE(schema: AnySchema, limit?: number): MethodDecorator;
...
export function DELETE(path: ControllerRoutePath, schema: AnySchema, limit?: number): MethodDecorator;
