...
import type { HttpPathValidator } from "../types/index.js";
import { Nullable } from "../types/internal.js";
import { getUrlWithoutQuery } from "../utils/internal.js";
 ...
 */
export function params<TRequest>(path: string): HttpPathValidator<TRequest> {
    ...
    return async (req: any) => {
        try {
            ...
            console.warn("[HTTP PARAMS ERROR]", error);
        }
