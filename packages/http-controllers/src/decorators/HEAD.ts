...
/**
 * Returns a decorator, that sets up an endpoint for a HEAD request.
 *
 * @example
 * ```
 * import { Controller, HEAD, IHttp1Request, IHttp1Response } from "@egomobile/http-controllers";
 *
 * @Controller()
 * export default class MyController {
 *     @HEAD('/')
 *     public async peekSomething(request: IHttp1Request, response: IHttp1Response) {
 *         // ...
 *     }
 * }
 * ```
 ...
 */
export function HEAD(): ClassMethodDecorator5;
export function HEAD(options: IHttpMethodDecoratorOptions): ClassMethodDecorator5;
export function HEAD(use: HttpMiddleware<any, any>[]): ClassMethodDecorator5;
export function HEAD(path: HttpMethodDecoratorRoutePath, use?: Nilable<HttpMiddleware<any, any>[]>): ClassMethodDecorator5;
export function HEAD(arg1?: Nilable<HttpMethodDecoratorArg1>, arg2?: Nilable<HttpMethodDecoratorArg2>): ClassMethodDecorator5 {
