...
/**
 * Returns a legacy TypeScript decorator, that sets up an endpoint for a TRACE request.
 *
 * @example
 * ```
...
export function TRACE(options: IHttpMethodDecoratorOptions): MethodDecorator;
export function TRACE(use: HttpMiddleware<any, any>[]): MethodDecorator;
export function TRACE(path: HttpMethodDecoratorRoutePath, use?: Nilable<HttpMiddleware<any, any>[]>): MethodDecorator;
export function TRACE(arg1?: Nilable<HttpMethodDecoratorArg1>, arg2?: Nilable<HttpMethodDecoratorArg2>): MethodDecorator {
