...
/**
 * Returns a decorator, that sets up an endpoint for a OPTIONS request.
 *
 * @example
 * ```
...
export function OPTIONS(options: IHttpMethodDecoratorOptions): ClassMethodDecorator5;
export function OPTIONS(use: HttpMiddleware<any, any>[]): ClassMethodDecorator5;
export function OPTIONS(path: HttpMethodDecoratorRoutePath, use?: Nilable<HttpMiddleware<any, any>[]>): ClassMethodDecorator5;
export function OPTIONS(arg1?: Nilable<HttpMethodDecoratorArg1>, arg2?: Nilable<HttpMethodDecoratorArg2>): ClassMethodDecorator5 {
